...
function Teachersingle(props) {
  return <div>
      <div className="teacherone pt-6 md:pt-0 margin mx-8 my-5">
      <div className="img">
      <img className="fimg rounded-lg " src={`	https://shelly.merku.love/wp-content/uploads/2020/11/${props.number}-270x405.png`} />
      </div>
